...
public class CreateAccountDefinitionsSteps {
    ...
    public void userfillFields(final ExamplesTable registrationTable){
        ...
        String userFirstName = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("firstName", String.class);
        String userLastName = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("lastName", String.class);
        String userEmail = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("email", String.class);
        String userPassword = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("password", String.class);
        String userConfirmPassword = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("confirmPassword", String.class);
    ...
    public void emptyFieldsHighlighted(String abc, final ExamplesTable registrationTable) {
        ...
        boolean replaceNamedParameters = true;
        String expectedText = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("expectedText", String.class);
        String emptyFields = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("position", String.class);
    ...
    public void incorrectFieldsHighlighted(final ExamplesTable registrationTable) {
        ...
        boolean replaceNamedParameters = true;
        String firstExpectedText = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("firstExpectedText", String.class);
        String secondExpectedText = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("secondExpectedText", String.class);
        String incorrectFields = registrationTable.getRowAsParameters(0, replaceNamedParameters).valueAs("position", String.class);
        String expectedText = firstExpectedText + secondExpectedText;
        String actual = createAccountSteps.getHighlightedTextInIncorrectFields(incorrectFields, firstExpectedText, secondExpectedText);
        Assert.assertThat(actual, is(expectedText));
